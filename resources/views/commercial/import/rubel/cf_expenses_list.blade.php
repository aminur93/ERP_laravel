    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h2 class="modal-title text-center" id="myModalLabel">C&F Expenses (Air)</h2>
            </div>
...
<script type="text/javascript">
	$(document).ready(function(){ 
	    ...
	    $('#dataTables').DataTable({
	        ...
	        ajax: '{!! url("commercial/import/cfexpenses_fetchlist") !!}',
	        columns: [  
...
@push('js')
     <script type="text/javascript">
        function deleteModal(id) {
            $('#modal_form').attr('action', "{{ url('/commercial/import/cf_expenses_delete') }}"+'/'+id);
            $('#edit_section').hide();
            $('#delete_section').show();
            $('#action_modal').modal();
        }
