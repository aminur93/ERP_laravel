	    ...
	    <div class="main-content-inner">
	        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
	            <ul class="breadcrumb">
	                ...
	                <li class="active"> C&F Expenses (Sea) </li>
	            </ul><!-- /.breadcrumb -->
	        </div>

	        <div class="page-content">
	            <div class="page-header">
	                <h1>Import <small><i class="ace-icon fa fa-angle-double-right"></i> C&F Expenses (Sea) </small></h1>
	            </div>
	            <!-- 1st ROW -->
	            <div class="row">
	            ...
	            <div class="panel panel-info">
	             	<div class="panel-heading page-headline-bar"><h5> C&F Expenses (Sea) <a href="{{ url('commercial/import/cfExpensesSea_list') }}" class="btn btn-info btn-sm pull-right">List of C&F Expenses (Sea)</a></h5> </div>
	         	</div>
	                <form action="{{ url('commercial/import/cfexpensesSea_save') }}" method="post">
	                	{{ csrf_field() }}
						<div class="row">
							<br>
		                    <div class="col-sm-12">
	...
	<script type="text/javascript">
		...
		$('#valueSearch').on('click', function() {
			...
			if(file_no != '' && doc_no != '') {
				...
				setTimeout(() => {
					$.ajax({
						url: '{{ url('commercial/import/cfexpensesSea_fetchentrydata') }}',
						type: 'POST',
						datatype: 'json',
		...
		$('#file_id').on('change', function() {
			$.ajax({
				url: '{{ url('commercial/import/cfexpensesSea_fetchtransdoc') }}',
				type: 'POST',
				datatype: 'json',
