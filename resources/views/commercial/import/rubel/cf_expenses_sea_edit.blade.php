...
<?php
    ...
    $b_total = $cfe->b1+$cfe->b2+$cfe->b3+$cfe->b4+$cfe->b5+$cfe->b6+$cfe->b7;
    $c_total = $cfe->c1+$cfe->c2+$cfe->c3+$cfe->c4+$cfe->c5+$cfe->c6+$cfe->c7+$cfe->c8+$cfe->c9+$cfe->c10;
    $d_total = $cfe->d1+$cfe->d2+$cfe->d3+$cfe->d4+$cfe->d5+$cfe->d6+$cfe->d7+$cfe->d8+$cfe->d9;
    $e_total = $cfe->e1+$cfe->e2+$cfe->e3+$cfe->e4+$cfe->e5;
    $f_total = $cfe->f1+$cfe->f2+$cfe->f3+$cfe->f4+$cfe->f5+$cfe->f6+$cfe->f7+$cfe->f8;
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content"> 
            ...
            <form action="{{ url('commercial/import/cfexpensesSea_update/'.$cfe->imp_sea_id) }}" method="post">
                {{ csrf_field() }}
                {{-- 2nd row --}}
                <div class="row">
                    <br>
                ...
                <div class="row divborder">
                    ...
                    <div class="col-sm-12" id="b_total_section">
                        ...
                        <div class="col-sm-4">
                            <label class="col-sm-2 control-label no-padding">Total (TK)</label>
                            <div class="col-sm-10">
                                <input type="number" id="b_total" name="b_total" placeholder="" value="{{ $cfe->b1+$cfe->b2+$cfe->b3+$cfe->b4+$cfe->b5+$cfe->b6+$cfe->b7 }}" min="0" class="form-control" readonly="readonly" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" id="c_total_section">
                        ...
                        <div class="col-sm-4">
                            <label class="col-sm-2 control-label no-padding">Total (TK)</label>
                            <div class="col-sm-10">
                                <input type="number" id="c_total" name="c_total" placeholder="" value="{{ $cfe->c1+$cfe->c2+$cfe->c3+$cfe->c4+$cfe->c5+$cfe->c6+$cfe->c7+$cfe->c8+$cfe->c9+$cfe->c10 }}" min="0" class="form-control" readonly="readonly" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" id="c6_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="c6" name="c6" placeholder="" value="{{ $cfe->c6 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="c7_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="c7" name="c7" placeholder="" value="{{ $cfe->c7 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="c8_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="c8" name="c8" placeholder="" value="{{ $cfe->c8 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="c9_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="c9" name="c9" placeholder="" value="{{ $cfe->c9 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="c10_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="c10" name="c10" placeholder="" value="{{ $cfe->c10 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    ...
                    <div class="col-sm-12" id="d_total_section">
                        ...
                        <div class="col-sm-4">
                            <label class="col-sm-2 control-label no-padding">Total (TK)</label>
                            <div class="col-sm-10">
                                <input type="number" id="d_total" name="d_total" placeholder="" value="{{ $cfe->d1+$cfe->d2+$cfe->d3+$cfe->d4+$cfe->d5+$cfe->d6+$cfe->d7+$cfe->d8+$cfe->d9 }}" min="0" class="form-control" readonly="readonly" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" id="d5_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="d5" name="d5" placeholder="" value="{{ $cfe->d5 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="d6_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="d6" name="d6" placeholder="" value="{{ $cfe->d6 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="d7_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="d7" name="d7" placeholder="" value="{{ $cfe->d7 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="d8_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="d8" name="d8" placeholder="" value="{{ $cfe->d8 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="d9_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="d9" name="d9" placeholder="" value="{{ $cfe->d9 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    ...
                    <div class="col-sm-12" id="e_total_section">
                        ...
                        <div class="col-sm-4">
                            <label class="col-sm-2 control-label no-padding">Total (TK)</label>
                            <div class="col-sm-10">
                                <input type="number" id="e_total" name="e_total" placeholder="" value="{{ $cfe->e1+$cfe->e2+$cfe->e3+$cfe->e4+$cfe->e5 }}" min="0" class="form-control" readonly="readonly" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" id="e4_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="e4" name="e4" placeholder="" value="{{ $cfe->e4 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="e5_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="e5" name="e5" placeholder="" value="{{ $cfe->e5 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    ...
                    <div class="col-sm-12" id="f_total_section">
                        ...
                        <div class="col-sm-4">
                            <label class="col-sm-2 control-label no-padding">Total (TK)</label>
                            <div class="col-sm-10">
                                <input type="number" id="f_total" name="f_total" placeholder="" value="{{ $cfe->f1+$cfe->f2+$cfe->f3+$cfe->f4+$cfe->f5+$cfe->f6+$cfe->f7+$cfe->f8 }}" min="0" class="form-control" readonly="readonly" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" id="f5_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="f5" name="f5" placeholder="" value="{{ $cfe->f5 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="f6_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="f6" name="f6" placeholder="" value="{{ $cfe->f6 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="f7_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="f7" name="f7" placeholder="" value="{{ $cfe->f7 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
                    <div class="col-sm-12" id="f8_section">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="f8" name="f8" placeholder="" value="{{ $cfe->f8 }}" min="0" class="form-control g_input"/>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
