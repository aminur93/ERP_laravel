...
// }
	...
	$e_row_count = 3;
	$f_row_count = 4;
	$a_total = repeat($cfExpensesData, 'a', $a_row_count);
	$b_total = repeat($cfExpensesData, 'b', $b_row_count);
	$c_total = repeat($cfExpensesData, 'c', $c_row_count);
	$d_total = repeat($cfExpensesData, 'd', $d_row_count);
	$e_total = repeat($cfExpensesData, 'e', $e_row_count);
	$f_total = repeat($cfExpensesData, 'f', $f_row_count);
...
?>
<input type="hidden" id="imp_air_id" name="imp_air_id" value="{{ isset($cfe->imp_air_id)?$cfe->imp_air_id:'' }}">
...
<div class="row divborder">
	<div class="col-sm-12" id="a_total_section">
    	...
    	<div class="col-sm-4">
        	...
        	<div class="col-sm-10">
				<input type="text" id="a_total" name="a_total" placeholder="" value="{{ $a_total }}" min="0" class="form-control" readonly="readonly" />
			</div>
    	</div>
	</div>
    ...
    <div class="col-sm-12" id="b8_section">
    	...
    	<div class="col-sm-4">
        	...
        	<div class="col-sm-10">
				<input type="number" id="b8" name="b8" placeholder="" value="{{ isset($cfe->b8)?$cfe->b8:'' }}" min="0" class="form-control g_input"/>
			</div>
    	</div>
    	<div class="col-sm-4"></div>
    </div>
