    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">C&F Expenses List</li>
            </ul><!-- /.breadcrumb --> 
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h2 class="modal-title text-center" id="myModalLabel">C&F Expenses (Sea)</h2>
            </div>
...
<script type="text/javascript">
	$(document).ready(function(){ 
	    ...
	    $('#dataTables').DataTable({
	        ...
	        ajax: '{!! url("commercial/import/cfexpensesSea_fetchlist") !!}',
	        columns: [  
	            {data: 'DT_RowIndex', name: 'DT_RowIndex'},  
	            {data: 'cm_imp_data_entry_id', name: 'cm_imp_data_entry_id'}, 
...
@push('js')
     <script type="text/javascript">
        function deleteModal(id) {
            $('#modal_form').attr('action', "{{ url('/commercial/import/cfExpensesSea_delete') }}"+'/'+id);
            $('#edit_section').hide();
            $('#delete_section').show();
            $('#action_modal').modal();
        }
