    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Machinery Master Information   </li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="page-content"> 
              <div class="page-header">
               <h1>Machinery <small><i class="ace-icon fa fa-angle-double-right"></i>Machinery Master Information   </small></h1>
            </div>
          <!---Form -->
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{{ url('comm/import/machinery/machinery_masterstore')}}" enctype="multipart/form-data">
                    {{ csrf_field() }} 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                              ...
                              <input type="text" name="unit"placeholder="Enter" id="unit" class="col-xs-12" readonly="readonly" /> 
                          </div>
                        </div> 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="manufacturer"placeholder="Enter" id="manufacturer" class="col-xs-12" readonly="readonly" /> 
                          </div>
                        </div> 
                      <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="lcno"placeholder="Enter" id="lcno" class="col-xs-12"  data-validation=" required"/> 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="date" name="lcdate" id="lcdate" class="col-xs-12"  data-validation=" required"/> 
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-9">
                             <input type="text" name="supplier"placeholder="Enter" id="supplier" class="col-xs-12" readonly="readonly" />
                          </div>
                     </div> 
                     <div class="form-group">
                          ...
                          <div class="col-sm-9">
                               {{ Form::select('section', $section, null, ['placeholder'=>'Select ','class'=> 'form-control col-xs-10', 'data-validation' => 'required']) }}
                          </div>
                     </div> 
