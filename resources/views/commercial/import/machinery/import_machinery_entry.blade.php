    ...
    <div class="main-content-inner">
        ...
        <div class="page-content"> 
              <div class="page-header">
               <h1> Machinery <small><i class="ace-icon fa fa-angle-double-right"></i>  Import Data Entry (Machinery)   </small></h1>
            </div>
          <!---Form -->
                 <h5 class="page-header">Add Information  </h5>
             <form class="form-horizontal" role="form" method="post" action="{{ url('comm/import/machinery/importdatastore')}}" enctype="multipart/form-data">
                    {{ csrf_field() }} 
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-8">
                              ...
                              {{ Form::select('ship', array('Ship'=>'Ship','Air'=>'Air','Road'=>'Road'), null, ['placeholder'=>'Select ','class'=> 'form-control col-xs-10']) }}
                  ...
                  <div class="col-sm-4">
                    ...
                    <!-- SECOND COLUMN BEGINS -->
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            {{ Form::select('mother_vessel', $vessel, null, ['placeholder'=>'Select ','id'=> 'vessel','class'=> 'form-control col-xs-10']) }}
                          </div>
                     </div> 
                     <div class="form-group">
