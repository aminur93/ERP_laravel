    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> PI Master Fabric Edit</li>
            </ul><!-- /.breadcrumb -->
        </div>

        <div class="page-content"> 
            <div class="page-header">
                <h1>Import <small><i class="ace-icon fa fa-angle-double-right"></i> PI Master Fabric Edit</small></h1>
            </div>
            <form class="form-horizontal" role="form" method="post" action="{{ url('commercial/import/pi/master_fabric/'.$piMaster->id.'/update') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <!-- 1st ROW -->
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="pi_no" name="pi_no" placeholder="PI No" value="{{ $piMaster->pi_no }}" class="form-control col-xs-12" data-validation="required length custom" data-validation-length="1-20"  data-validation-regexp="^([-a-z A-Z0-9]+)$"/>
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::select("cm_file_id", $fileList, $piMaster->cm_file_id, ['class'=>'col-xs-12 form-control', 'id'=>'cm_file_id', 'placeholder'=>'Select File No', 'data-validation'=>'required']) }}
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::select("mr_supplier_sup_id", $supplierList, $piMaster->mr_supplier_sup_id, ['class'=>'col-xs-12 form-control', 'id'=>'mr_supplier_sup_id', 'placeholder'=>'Select Supplier', 'data-validation'=>'required']) }}
                                </div>
                            </div>   
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="pi_category" class="form-control col-xs-12" data-validation="required">
                                        <option value="Foreign" {{ ($piMaster->pi_category=="Foreign")? "selected": null }}>Foreign</option>
                                        <option value="Local" {{ ($piMaster->pi_category=="Local")? "selected": null }}>Local</option>
                                    </select>
                                </div>
                            </div>   
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="ship_mode" class="form-control col-xs-12" data-validation="required">
                                        <option value="Sea" {{ ($piMaster->ship_mode=="Sea")? "selected": null }}>Sea</option>
                                        <option value="Air" {{ ($piMaster->ship_mode=="Air")? "selected": null }}>Air</option>
                                        <option value="Road" {{ ($piMaster->ship_mode=="Road")? "selected": null }}>Road</option>
                                    </select>
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="pi_status" class="form-control col-xs-12" data-validation="required">
                                        <option value="Active" {{ ($piMaster->pi_status=="Active")? "selected": null }}>Active</option>
                                        <option value="Inactive" {{ ($piMaster->pi_status=="Inactive")? "selected": null }}>Inactive</option>
                                    </select>
                                </div>
                            </div>    
                        </div> 
                        ...
                        <div class="col-sm-7 col-sm-offset-1">
                            ...
                            <table class="table table-bordered table-striped" id="dataTables">
                                ...
                                <tbody id="order_list">{!! $order_list_data !!}</tbody>
                            </table>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                               ...
                               <td id="fabric_total_qty">{{ $fabric_total_qty }}</td> 
                               <td></td> 
                               <td></td> 
                               <td id="fabric_total_pi_qty">{{ $fabric_total_pi_qty }}</td> 
                               <td id="fabric_total_pi_value">{{ $fabric_total_pi_value }}</td> 
                               <td></td> 
                               <td></td> 
                            </tr>
                            {{-- Sewing Category --}}
                            ...
                            <tr>
                               ...
                               <td id="sewing_total_qty">{{ $sewing_total_qty }}</td> 
                               <td></td> 
                               <td></td> 
                               <td id="sewing_total_pi_qty">{{ $sewing_total_pi_qty }}</td> 
                               <td id="sewing_total_pi_value">{{ $sewing_total_pi_value }}</td> 
                               <td></td> 
                               <td></td> 
                            </tr>
                            {{-- Finishing Category --}}
                            ...
                            <tr>
                               ...
                               <td id="finishing_total_qty">{{ $finishing_total_qty }}</td> 
                               <td></td> 
                               <td></td> 
                               <td id="finishing_total_pi_qty">{{ $finishing_total_pi_qty }}</td> 
                               <td id="finishing_total_pi_value">{{ $finishing_total_pi_value }}</td> 
                               <td></td> 
                               <td></td>  
                            </tr>
                            ...
                            <tr>
                               ...
                               <td id="grand_total_qty">{{ $grand_total_qty }}</td> 
                               <td></td> 
                               <td></td> 
                               <td id="grand_total_pi_qty">{{ $grand_total_pi_qty }}</td> 
                               <td id="grand_total_pi_value">{{ $grand_total_pi_value }}</td> 
                               <td></td> 
                               <td></td>  
                            </tr>
...
$(document).ready(function(){
    ...
    $("#mr_supplier_sup_id").on("change", function(e){
        ...
        $("#sewing_cat").html("");
        $("#finish_cat").html("");
        $("#fabric_total_qty").text(0);
        $("#fabric_total_pi_qty").text(0);
        $("#fabric_total_pi_value").text(0);
        $("#sewing_total_qty").text(0);
        $("#sewing_total_pi_qty").text(0);
        $("#sewing_total_pi_value").text(0);
        $("#finishing_total_qty").text(0);
        $("#finishing_total_pi_qty").text(0);
        $("#finishing_total_pi_value").text(0);
        $("#grand_total_qty").text(0);
        $("#grand_total_pi_qty").text(0);
        $("#grand_total_pi_value").text(0);
