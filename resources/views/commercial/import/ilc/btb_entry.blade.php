    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> BTB Entry (Fabric, Accessories) </li>
            </ul><!-- /.breadcrumb -->
        </div>

        <div class="page-content">
            <div class="page-header">
                <h1>Import <small><i class="ace-icon fa fa-angle-double-right"></i> BTB Entry (Fabric, Accessories) </small></h1>
            </div>
            ...
            <div class="row">
                ...
                <form class="form-horizontal" role="form" method="post" action="{{ url('commercial/import/ilc/btb_entry')  }}" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     {{-- Part 1 --}}
                    <div class="col-sm-12">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::select('mr_supplier_sup_id', $supplierList, null, ['id'=>'mr_supplier_sup_id', 'placeholder' =>'Select Supplier', 'class' => 'col-xs-12', 'data-validation'=>'required'])}}
                                </div>
                            </div>
