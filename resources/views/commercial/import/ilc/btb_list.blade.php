    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">BTB(Fabric, Accessories) List</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content"> 
            <div class="page-header">
                <h1>Import<small> <i class="ace-icon fa fa-angle-double-right"></i>BTB(Fabric, Accessories) List</small></h1>
            </div>
...
$(document).ready(function(){
    ...
    $('#dataTables').DataTable({
        ...
        ajax: '{!! url("commercial/import/ilc/btb_list_data") !!}',
