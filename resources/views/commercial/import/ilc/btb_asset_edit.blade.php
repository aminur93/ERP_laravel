    ...
    <div class="main-content-inner">
        ...
        <div class="page-content"> 
            ...
            <div class="row">
                ...
                @include('inc/message')
                <form class="form-horizontal" role="form" method="post" action="{{ url('commercial/import/ilc/btb_asset_update')  }}" enctype="multipart/form-data">
                     {{ csrf_field() }} 
                    {{-- Part 1 --}}
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12 hide" id="amend_div">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="am_amend_id" id="am_amend_id" value="<?php printf($last_amend->amend_no+1); ?>" class="col-xs-12 form-control" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
