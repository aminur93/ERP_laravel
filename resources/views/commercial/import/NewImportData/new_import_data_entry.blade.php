        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="#"> New Import Data</li>
                    <li class="active"> New Import Data Entry   </li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1> New Import Data <small><i class="ace-icon fa fa-angle-double-right"></i> New Import Data Entry  </small></h1>
                </div>
                <!---Form -->
                <h5 class="page-header">Add Information  </h5>
                <form class="form-horizontal" role="form" method="post" action="{{ url('comm/newimportstore')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="col-md-4">
                            <div class="table-responsive">
                                <table id="bomTable" class="table table-bordered table-striped table-highlight" >
                                    ...
                                    <tr id="invoice-0" class="no-padding">

                                        <td>
                                            <input type="text" name="invoiceno[]" placeholder="Enter"class="form-control" />
                                            <input type="hidden" name="rowno[]" value="invoice-0" class="invrow" />
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-xs btn-primary Addpi">Add PI</button>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '.Addpi', function () {
                var na = $(this).parent().parent().attr('id');
                //console.log(na);
                $.ajax({
                    url: "{{url('comm/pi_no')}}/"+na,
            ...
            $('body').on('click', '.AddBtn', function(){
                ...
                var data = '<tr id="pirow-'+counts+'" class="no-padding">'+
                    ...
                    '@endforeach'+
                    '</select>'+
                    '<input type="hidden" name="rowno[]" value="pirow-'+counts+'" class="pirow" />'+
                    ' </td>'+
            ...
            $(document).on('change', '#pi_no', function(e){
                ...
                var an = $(this).parent().parent().attr('id');

                if(pi_master_id){
                    $.ajax({
                        url: "{{url('comm/Pi_bom')}}/"+an,
                        type: 'get',
            ...
            $('body').on('click', '.AddBtns', function(){
                ...
                var data = '<tr id="pibom'+countss+'" class="no-padding">'+
                    ...
                    '@endforeach'+
                    '</select>'+
                    '<input type="hidden" name="rowno[]" value="pibom'+countss+'" class="pirow" />'+
