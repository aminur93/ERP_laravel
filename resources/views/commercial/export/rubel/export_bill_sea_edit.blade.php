    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> Edit Export Bill (Sea) </li>
            </ul><!-- /.breadcrumb -->
        </div>

        <div class="page-content">
            <div class="page-header">
                <h1>Export <small><i class="ace-icon fa fa-angle-double-right"></i> Edit Export Bill (Sea) </small></h1>
            </div>
            <!-- 1st ROW -->
            <div class="row">
            ...
            <form action="{{ url('commercial/export/export_bill_sea_update/'.$exportBillSeaData->exp_bill_sea_id) }}" method="post">
                {{ csrf_field() }}
                {{-- 3rd row --}}
                <div class="row">
                    <br>
