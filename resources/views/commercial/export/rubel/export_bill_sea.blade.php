	    ...
	    <div class="main-content-inner">
	        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
	            <ul class="breadcrumb">
	                ...
	                <li class="active"> Export Bill (Sea) </li>
	            </ul><!-- /.breadcrumb -->
	        </div>

	        <div class="page-content"> 
	            <div class="page-header">
	                <h1>Export <small><i class="ace-icon fa fa-angle-double-right"></i> Export Bill (Sea) </small></h1>
	            </div>
	            <!-- 1st ROW -->
	            <div class="row">
	            ...
	            <div class="panel panel-info">
	             	<div class="panel-heading page-headline-bar"><h5> Export Bill (Sea) <a href="{{ url('commercial/export/export_bill_sea_list') }}" class="btn btn-info btn-sm pull-right">List of Export Bill (Sea)</a></h5> </div>
	         	</div>
	                <form action="{{ url('commercial/export/export_bill_sea_save') }}" method="post">
	                	{{ csrf_field() }}
						<div class="row">
							<br>
		                    <div class="col-sm-12">
	...
	<script type="text/javascript">
		...
		$('#valueSearch').on('click', function() {
			...
			if(file_no != '' && inv_no != '') {
				...
				setTimeout(() => {
					$.ajax({
						url: '{{ url('commercial/export/export_bill_sea_fetchentrydata') }}',
						type: 'POST',
						datatype: 'json',
		...
		$('#file_id').on('change', function() {
			$.ajax({
				url: '{{ url('commercial/export/export_bill_sea_fetchinvno') }}',
				type: 'POST',
				datatype: 'json',
