    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Export Bill (Sea) List</li>
            </ul><!-- /.breadcrumb --> 
        </div>

        <div class="page-content">  
            <div class="page-header">
                <h1>Export <small><i class="ace-icon fa fa-angle-double-right"></i> Export Bill (Sea) List </small></h1>
            </div>
            @include('inc/message')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                <h2 class="modal-title text-center" id="myModalLabel">Export Bill (Sea)</h2>
            </div>
...
<script type="text/javascript">
	$(document).ready(function(){ 
	    ...
	    $('#dataTables').DataTable({
	        ...
	        ajax: '{!! url("commercial/export/export_bill_sea_fetchlist") !!}',
	        columns: [  
...
@push('js')
     <script type="text/javascript">
        function deleteModal(id) {
            $('#modal_form').attr('action', "{{ url('/commercial/export/export_bill_sea_delete') }}"+'/'+id);
            $('#edit_section').hide();
            $('#delete_section').show();
            $('#action_modal').modal();
        }
