	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Order Costing Edit</li>
			</ul><!-- /.breadcrumb --> 
		</div>
		...
		<div class="page-content  table-responsive">   
            ...
            @include('inc/message')
            {{ Form::open(['url'=>('merch/order_costing/'.request()->segment(3).'/edit'), 'class'=>'row']) }}
 
	            <div class="page-header text-right">
	            	@if($check_booking)
	            	<a href='{{ url("merch/order_booking/".$order->order_id."/create") }}' class="btn btn-sm btn-success" title="Edit Booking"><i class="glyphicon  glyphicon-pencil"></i></a>
	            	@else
	            	<a href='{{ url("merch/order_booking/".$order->order_id."/create") }}' class="btn btn-sm btn-success" title="Booking"><i class="glyphicon  glyphicon-bold"></i></a>
	            	@endif
                	<a href='{{ url("merch/order_costing") }}' class="btn btn-sm btn-info" title="Costing List"><i class="glyphicon glyphicon-th-list"></i></a>
	            </div>
