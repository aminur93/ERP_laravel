                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" id="stl_product_name" name="stl_product_name" value="{{ $style->stl_product_name }}" placeholder="Enter Text" class="col-xs-12" data-validation="required length custom" data-validation-length="1-50" data-validation-regexp="^([,-./;:_()%$&a-z A-Z0-9]+)$"/>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" id="stl_smv" name="stl_smv" value="{{ $style->stl_smv }}" placeholder="Enter Value" class="col-xs-12"  data-validation="required length custom" data-validation-length="1-20" data-validation-regexp="^([,-./;:_()%$&a-z A-Z0-9]+)$"/>               
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" id="stl_cm" name="stl_cm" value="{{ $style->stl_cm }}" placeholder="Enter value" class="col-xs-12"  data-validation="required length custom" data-validation-length="1-20" data-validation-regexp="^([,-./;:_()%$&a-z A-Z0-9]+)$"/>                       
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" id="stl_wash" name="stl_wash" value="{{ $style->stl_wash }}" placeholder="Enter value" class="col-xs-12"  data-validation="required length custom" data-validation-length="1-20" data-validation-regexp="^([,-./;:_()%$&a-z A-Z0-9]+)$"/>   
                            </div>
                       </div>
                    </div>
