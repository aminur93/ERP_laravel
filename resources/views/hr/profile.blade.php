													...
													<div class="col-xs-10">
														<table class="table table-borderd" style="border:1px solid #6EAED1">
															...
															<tr>
																...
																<td style="padding:4px">{{ (14-$leave->casual) }}</td>
															</tr>
															<tr>
															...
															<tfoot>
																<tr>
																	...
																	<td style="padding:4px">{{ (14-$leave->casual)+(0)+(10-$leave->sick)+(120-$leave->maternity) }}</td>
																</tr>
															</tfoot>
														</table>
													</div>
