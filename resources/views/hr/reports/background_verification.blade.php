    ...
    <div class="main-content-inner">
        ...
        <div class="page-content"> 
            ...
            <div class="page-header">
                <h1>Reports<small><i class="ace-icon fa fa-angle-double-right"></i> Background Verification</small></h1>
            </div>

            <div class="row">
                 @include('inc/message')
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" method="post" action="{{ url('hr/reports/back_verf') }}" enctype="multipart/form-data"> 

                         {{ csrf_field() }} 
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="associate_id"> Associate's ID<span style="color: red">&#42;</span></label>
                            <div class="col-sm-9">
                                {{ Form::select('associate_id', [Request::get('associate_id') => Request::get('associate_id')], Request::get('associate_id'),['placeholder'=>'Select Associate\'s ID', 'data-validation'=> 'required', 'id'=>'associate_id',  'class'=> 'associates no-select col-xs-10 col-sm-5']) }} 
                                 <a id="generate" class="btn btn-primary btn-sm" href="{{ url('hr/reports/back_verf?associate_id=%ASSOCIATE_ID%') }}">Generate</a>
                                 @if(!empty(Request::get('associate_id')))
                                 <button type="button" onClick="printMe()" class="btn btn-warning btn-sm" title="Print"><i class="fa fa-print"></i> 
                                </button>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8" id="printable" style="font-size: 9px;">
                                <textarea class="tinyMceLetter hide" name="printArea" id="printArea">
                                    <?php
...
<script type="text/javascript">
    ...
    $('body').on('change', '.associates', function(){
        ...
        function printMe(){ 
            ...
            myWindow.document.write(document.getElementById('printArea').value);
