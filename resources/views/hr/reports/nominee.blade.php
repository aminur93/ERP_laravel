    ...
    <div class="main-content-inner">
        ...
        <div class="page-content"> 
            ...
            <div class="page-header">
                <h1>Reports<small><i class="ace-icon fa fa-angle-double-right"></i> Nominee</small></h1>
            </div>
            <div class="row">
                <form role="form" method="get" action="{{ url('hr/reports/nominee') }}">
                    <div class="col-sm-10"> 
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <button type="button" onClick="printMe()" class="btn btn-warning btn-sm" title="Print">
            ...
            <div class="row">
                ...
                <div class="col-sm-10" style="margin-top:20px">
                    <div class="form-group">
                        <div class="col-xs-12">
                        <textarea class="tinyMceLetter hide" id="PrintArea">
                            <?php
                            ...
                            <p style="margin:20px auto;text-align:justify;">প্রত্যয়ন করিতেছি যে, আমার উপস্থিতিতে জনাব/জনাবা <font style="width:160px;border-bottom:1px dotted #999; display:inline-block">{{ (!empty($info->hr_bn_associate_name)?$info->hr_bn_associate_name:null) }}&nbsp;</font> লিপিবদ্ধ বিবরণসমূহ পাঠ করিবার পর উক্ত ঘোষণা সাক্ষর করিয়াছেন। </p>
