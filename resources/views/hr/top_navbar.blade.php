	...
	<div class="navbar-container ace-save-state" id="navbar-container">
		...
		<div class="navbar-header pull-left">
			...
			<a href="{{ url('/dashboard') }}" class="navbar-brand">
				<small><img src="{{ asset('assets/images/avatars/mbm_logo.png') }}" height="21px" style="padding: 0px;" class="msg-photo" alt="Logo" /> Human Resource Management</small>
			</a>
		</div>
								...
								<li>
									<a href=" {{ url('hr/notification/loan/loan_app_list') }} ">
										<div class="clearfix">
											...
											<span class="pull-right badge badge-info">+{{ $loan_applied_count }}</span>
										</div>
									</a>
								</li>
								...
								<li>
									<a href="{{ url('hr/notification/leave/leave_app_list') }}">
										<div class="clearfix">
											...
											<span class="pull-right badge badge-info">+{{ $leave_applied_count }}</span>
										</div>
									</a>
								</li>
								...
								<li>
									<a href="{{ url('hr/notification/appraisal/performance_appraisal_list') }}">
										<div class="clearfix">
											...
											<span class="pull-right badge badge-info">+{{ $performance_appraisal }}</span>
										</div>
									</a>
								</li>
								...
								<li>
									<a href="{{ url('hr/notification/greivance/greivance_appeal_list') }}">
										<div class="clearfix">
											...
											<span class="pull-right badge badge-info">+{{ $grieve_appeal_count }}</span>
										</div>
									</a>
								</li>
								...
								<li>
									<a href="{{ url('hr/notification/training/training_list') }}">
										<div class="clearfix">
											...
											<span class="pull-right badge badge-info">+{{ $taraining_assign_count }}</span>
										</div>
									</a>
								</li>
							</ul>
