                ...
                <div class="col-xs-12">
                    {{ Form::open(['url'=>'hr/timeattendance/station_card_update', 'class'=>'form-horizontal', 'method'=>'POST']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="associate_id" id="associate_id" class="col-xs-10 col-sm-5" value="{{ $station->associate_id }}" readonly>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="unit" class="col-xs-10 col-sm-5" value="{{ $station->hr_unit_name }}" readonly>
                            </div>
                        </div>   
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"> Floor </label>
                            <div class="col-sm-9">
                                <input type="text" id="floor" class="col-xs-10 col-sm-5" value="{{ $station->hr_floor_name }}" readonly>
                            </div>
                        </div>   
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"> Line </label>
                            <div class="col-sm-9">
                                <input type="text" id="line" class="col-xs-10 col-sm-5" value="{{ $station->hr_line_name }}" readonly>
                            </div>
                        </div>   
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"> Shift </label>
                            <div class="col-sm-9">
                                <input type="text" id="shift" class="col-xs-10 col-sm-5" value="{{ $station->hr_shift_name }}" readonly>
                            </div>
                        </div>     
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="floor_id">Changed Floor </label>
                            <div class="col-sm-9">
                                {{Form::select('floor_id', $floorList, $station->changed_floor, ['id'=> 'floor_id', 'placeholder' => "Select Floor", 'class'=> "no-select col-xs-10 col-sm-5", 'data-validation'=>'required'])}}
                            </div>
                        </div>      
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="line_id">Changed Line </label>
                            <div class="col-sm-9">
                                {{Form::select('line_id', $lineList, $station->changed_line, ['id'=> 'line_id', 'placeholder' => "Select Line", 'class'=> "no-select col-xs-10 col-sm-5", 'data-validation'=>'required'])}}
                            </div>
                        </div>     
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="start_date" class="datetimepicker col-xs-10 col-sm-5" value="{{ $station->start_date }}" placeholder="Start Date" data-validation="required">
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="end_date" class="datetimepicker col-xs-10 col-sm-5" value="{{ $station->end_date }}" placeholder="End Date" data-validation="required">
                            </div>
                        </div>    
